let sistemaSolar = {
  ...
  let planet1 = window.prompt('Introduce el nombre de un planeta')
  let planet2 = window.prompt('Introduce el nombre de un planeta')
  let planet3 = window.prompt('Introduce el nombre de un planeta')
